...
export class InMemoryDatabase implements InMemoryDbService{
    createDb(){
        const categories: Category[] = [
            ...
            { id: 2, name: "Saúde", description: "Pagamento de plano de Saúde"},
            { id: 3, name: "Remédio", description: "Pagamentos de Remédios"},
            { id: 4, name: "Salário", description: "Recebimento de Salário"},
            { id: 5, name: "Freelas", description: "Recebimento de Freelas"}
        ];
